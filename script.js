...
// *** সাউন্ড প্লে করার জন্য একটি Helper ফাংশন ***
const playSound = (soundId) => {
    const sound = document.getElementById(soundId);
    if (sound) {
        sound.currentTime = 0;
        sound.play().catch(error => {
            console.info(`Could not play sound: ${soundId}. User interaction might be needed.`);
        });
    }
};

// *** সুন্দর টোস্ট নোটিফিকেশনের ফাংশন (আপগ্রেড করা) ***
